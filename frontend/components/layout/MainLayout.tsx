      ...
      <div className="hidden lg:flex w-72 shrink-0 h-screen animate-pulse"
        ...
        <div className="flex flex-col w-full p-5 gap-4">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-amber-500/30 shrink-0" />
            <div className="space-y-2 flex-1">
              <div className="h-3 bg-white/20 rounded w-3/4" />
              <div className="h-2 bg-amber-400/30 rounded w-1/2" />
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 p-6 space-y-5 animate-pulse">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[...Array(4)].map((_, i) => <div key={i} className="h-28 bg-amber-50 rounded-2xl border border-amber-100" />)}
          </div>
